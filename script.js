...
const loadSavedChatHistory = () => {
  ...
  savedConversations.forEach((conversation) => {
    ...
    showTypingEffect(responseText, parsedApiResponse, incoming.querySelector(".message__text"), incoming, true);
  });
...
const requestApiResponse = async (incomingMessageElement) => {
  ...
  try {
    ...
    showTypingEffect(responseText, parsedApiResponse, msgEl, incomingMessageElement);

    let logs = JSON.parse(localStorage.getItem("saved-api-chats")) || [];
    logs.push({ userMessage: currentUserMessage, apiResponse: responseData });
...
const displayLoadingAnimation = () => {
  ...
  const loading = createChatMessageElement(html, "message--incoming", "message--loading");
